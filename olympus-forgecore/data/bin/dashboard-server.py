...
def status():
    ...
    x["bootstrap_beta51_seen"] = "ForgeCore 0.1.0-beta.51 runner bootstrap started" in bootstrap_text
    ...
    def do_GET(self):
        ...
        if parsed.path == "/":
            ...
            self.send_json(200, {
                ...
                "bootstrap_beta51_seen": bool(current.get("bootstrap_beta51_seen")),
            })
        else:
