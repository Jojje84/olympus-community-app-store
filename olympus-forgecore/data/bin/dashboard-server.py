...
def status():
    ...
    x["bootstrap_beta46_seen"] = "ForgeCore 0.1.0-beta.46 runner bootstrap started" in bootstrap_text
    ...
    def do_GET(self):
        ...
        if parsed.path == "/":
            ...
            self.send_json(200, {
                ...
                "bootstrap_beta46_seen": bool(current.get("bootstrap_beta46_seen")),
            })
        else:
