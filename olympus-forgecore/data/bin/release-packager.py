...
an Olympus Releases publication. Network publication is deliberately separate so
...
def build_release_bundle(job, artifact_root, output_root, source_revision):
    ...
    if not release_repo:
        raise ReleasePackagingError("Global Olympus Releases repository is not configured")
