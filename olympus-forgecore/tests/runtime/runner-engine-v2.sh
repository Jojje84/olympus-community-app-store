...
mkdir -p "${FORGECORE_APP_ROOT}/config/runners" "${FORGECORE_APP_ROOT}/state" \
  "${FORGECORE_STORAGE_ROOT}/runners/jojje84-forgecore" "${FORGECORE_STORAGE_ROOT}/runner-engine-v2" \
...
test ! -f "${FORGECORE_STORAGE_ROOT}/runner-engine-v2/jojje84-forgecore/.runner"
